...
?>
                    ...
                    $query = "SELECT news_id,title,date,news.category_id,name
					FROM news
					join category
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['name'] ?></td>                                       
                                           <td>
											<a href="editnews.php?id=<?php echo $row['news_id'] ?>" class="btn btn-info">
                                                Edit
                                            </a>
								
                                            <a onclick="return confirm('Are You Sure to Delete This News ??')"
											href="deletenews.php?id=<?php echo $row['news_id'] ?>" class="btn btn-danger">
                                                Delete
                                            </a>
											</td>
                                    </tr>
